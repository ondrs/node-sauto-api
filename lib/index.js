 ...
 * @constructor
 */
function SautoApi(config, login, password, swKey) {
  this.config_ = config;
  this.login_ = login;
...
SautoApi.prototype.loginInternal_ = function (sessionId, hash) {
  ...
  self.client_.methodCall('login', [sessionId, password, self.swKey_], function (err, result) {
